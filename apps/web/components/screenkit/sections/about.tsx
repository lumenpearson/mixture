...
import { PROJECT_SUBTITLE, PROJECT_VERSION } from "@/lib/screenkit/data"
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid gap-2 rounded-2xl border border-panel-border bg-control px-4 py-3">
          ...
          <KeyVal label="rpc" value="protobuf · connectrpc · grpc-web" />
        ...
        <div className="flex flex-col">
          {categories.map((c) => {
            ...
            return (
              ...
              >
                <span className="flex min-w-0 items-center gap-2 font-mono text-sm lowercase text-foreground">
                  <span className="size-1.5 shrink-0 rounded-full" style={{ background: c.accent }} />
                  <span className="truncate">{catLabel(c.id)}</span>
                </span>
